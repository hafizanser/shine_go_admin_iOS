...
class WebViewVC: UIViewController, WKNavigationDelegate {
    ...
    enum K {
        static let PRIVACY_POLICY_URL: String = "https://www.shinengo.net/privacy-policy"
        static let TERMS_URL: String = "https://www.shinengo.net/terms-conditions"
    }
    ...
    private var  termsNConditionUrl = URL(string: K.TERMS_URL)
    private var  privacyPolicyUrl = URL(string:  K.PRIVACY_POLICY_URL)
